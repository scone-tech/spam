...
#		os.system('clear')
	...
	def main(self,no,msg):
		...
		if 'SMS Gratis Derguar tashme' in str(sub):
			print('[+] Sukses Dergoj ne ',nr)
		elif 'ju lutem Prisni 'në yll (nën):
			print('[!] Prisni disa momente për të dërguar të njëjtat sms')
		else:
			print('[-] Deshtoi  sms ne',nr)
